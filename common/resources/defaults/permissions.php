...
return [
    ...
    'all' => [
        ...
        'files' => [
            ...
            [
                'name' => 'files.download.mp3',
                'advanced' => true,
                'description' =>
                    'Allow downloading all uploaded MP3 files on the site. Users can download their own uploads (where applicable) without this permission.',
            ],
            [
                'name' => 'files.download.wav',
                'advanced' => true,
                'description' =>
                    'Allow downloading all uploaded WAV files on the site. Users can download their own uploads (where applicable) without this permission.',
            ],
            [
                'name' => 'files.download.zip',
                'advanced' => true,
                'description' =>
                    'Allow downloading all uploaded ZIP files on the site. Users can download their own uploads (where applicable) without this permission.',
            ],
            [
                'name' => 'files.download.pdf',
                'advanced' => true,
                'description' =>
                    'Allow downloading all uploaded PDF files on the site. Users can download their own uploads (where applicable) without this permission.',
            ],
        ],
