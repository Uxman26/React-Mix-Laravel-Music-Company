...
import {TrackDownloadOptionsColumn} from '@app/web-player/tracks/track-table/track-download-options-column';
import {TrackLikeOptionsColumn} from '@app/web-player/tracks/track-table/track-like-options-column';
...
const columnConfig: ColumnConfig<Track>[] = [
  ...
  },
  {
    ...
    body: (track, row) => {
      ...
      return <TrackLikeOptionsColumn track={track} isHovered={row.isHovered} />;
    },
  },
  {
    key: 'download',
    ...
    body: (track, row) => {
      ...
      return <TrackDownloadOptionsColumn track={track} isHovered={row.isHovered} />;
    },
  },
  {
    key: 'options',
