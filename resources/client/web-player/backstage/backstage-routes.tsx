...
import {TracksDatatablePage} from '@app/studio/tracks-datatable-page/tracks-datatable-page';
import {LicensesDatatablePage} from '@app/studio/licenses-datatable-page/licenses-datatable-page';
...
const RouteConfig: RouteObject[] = [
  ...
  // Licenses
  {
    path: 'licenses',
    element: (
      <AuthRoute permission="licenses.create">
        <BackstageLayout>
          <LicensesDatatablePage/>
        </BackstageLayout>
      </AuthRoute>
    ),
  },
...
function TracksWithArtistId() {
  const {artistId} = useParams();

  // Check if artistId exists before rendering TracksDatatablePage
  return artistId ? <TracksDatatablePage /> : <TracksDatatablePage />;
}
