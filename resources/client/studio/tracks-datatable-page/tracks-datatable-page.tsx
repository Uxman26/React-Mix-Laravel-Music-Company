...
import {TracksDatatableColumns} from '@app/studio/tracks-datatable-page/tracks-datatable-columns';
import {TracksDatatableFilters} from '@app/studio/tracks-datatable-page/tracks-datatable-filters';
import {useSettings} from '@common/core/settings/use-settings';
import {useNavigate} from '@common/utils/hooks/use-navigate';
import {DialogTrigger} from '@common/ui/overlays/dialog/dialog-trigger';
import {Tooltip} from '@common/ui/tooltip/tooltip';
import {IconButton} from '@common/ui/buttons/icon-button';
import {ImportTrackDialog} from '@app/studio/tracks-datatable-page/import-track-dialog';
...
export function TracksDatatablePage() {
  ...
  return (
    <DataTablePage
      endpoint={artistId ? `artists/${artistId}/tracks` : 'tracks'}
