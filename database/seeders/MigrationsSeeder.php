...
class MigrationsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('migrations')->insert([
            ...
            207 => array(
                'id' => 208,
                'migration' => '2024_04_25_220337_create_maintenance_mode_table',
                'batch' => 2,
            ),
            208 => array(
                'id' => 209,
                'migration' => '2024_04_27_110155_add_columns_to_tracks',
                'batch' => 3,
            ),
            209 => array(
                'id' => 210,
                'migration' => '2024_05_14_223157_create_licenses_table',
                'batch' => 4,
            ),
        ]);
    }
